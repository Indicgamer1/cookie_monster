...
namespace Eduzo.Games.CookieMonster.UI
{
    ...
    /// </summary>
    public class CookieMonsterPracticeCompleteScreen : CookieMonsterUIScreen
    {
        [Header("Results")]
        ...
        private void OnTryAgainClicked()
        {
            ...
            {
                var currentState = stateManager.GetCurrentState() as CookieMonsterPracticeCompleteState;
