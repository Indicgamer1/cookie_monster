...
namespace Eduzo.Games.CookieMonster.UI
{
    ...
    /// </summary>
    public class CookieMonsterQuestionSubmissionScreen : CookieMonsterUIScreen
    {
        [Header("Buttons")]
        ...
        private CookieMonsterNewQuestionGenerator _questionGenerator;
        ...
        public override void Initialize()
        {
            ...
            _questionGenerator = CookieMonsterNewQuestionGenerator.Instance;
            ...
            // Load GameConfig
            _config = Resources.Load<CookieMonsterGameConfig>("GameConfig/GameConfig");
            if (_config == null)
            {
        ...
        private void OnSubmitClicked()
        {
            ...
            {
                var currentState = stateManager.GetCurrentState() as CookieMonsterQuestionSubmissionState;
        ...
        private void AddQuestionInputField()
        {
            ...
            {
                var questionInputField = inputField.GetComponent<CookieMonsterQuestionInputField>();
        ...
        private void RemoveQuestionInputField()
        {
            if (_questionInputFields.Count > 0)
            {
                ...
                if (lastField != null)
                {
                    var questionInputField = lastField.GetComponent<CookieMonsterQuestionInputField>();
        ...
        private (int dividend, int divisor)? GenerateUniqueDivisionQuestion()
        {
            if (_config == null)
            {
                Debug.LogError("CookieMonsterGameConfig is null! Cannot generate question.");
                return null;
            }
