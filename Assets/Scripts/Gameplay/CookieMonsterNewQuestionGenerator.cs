...
namespace Eduzo.Games.CookieMonster.Gameplay
{
    ...
    /// </summary>
    public class CookieMonsterNewQuestionGenerator : MonoBehaviour
    {
        ...
        private static CookieMonsterNewQuestionGenerator _instance;
        public static CookieMonsterNewQuestionGenerator Instance
        {
            get
            {
                if (_instance == null)
                {
                    ...
                    _instance = obj.GetComponent<CookieMonsterNewQuestionGenerator>();
                    if (_instance == null)
                    {
                        _instance = obj.AddComponent<CookieMonsterNewQuestionGenerator>();
                    }
                }
                return _instance;
            }
        ...
        public void SubmitQuestions()
        {
            ...
            var questionFields =
                FindObjectsByType<CookieMonsterQuestionInputField>(FindObjectsInactive.Exclude, FindObjectsSortMode.None);
