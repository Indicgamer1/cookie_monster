...
namespace Eduzo.Games.CookieMonster.Gameplay
{
    ...
    /// </summary>
    public class CookieMonsterRemainderErrorHandler : MonoBehaviour
    {
        [Header("Audio")]
        ...
        private void Start()
        {
            ...
            _cookieMonsterEventManager?.Subscribe<RemainderErrorEvent>(OnRemainderError);
        }
        ...
        {
            _cookieMonsterEventManager?.Unsubscribe<RemainderErrorEvent>(OnRemainderError);
        }
    }
}
