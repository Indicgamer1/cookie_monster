...
namespace Eduzo.Games.CookieMonster.Gameplay
{
    ...
    /// </summary>
    public class CookieMonsterFakeCookieSpawner : MonoBehaviour
    {
        [Header("References")]
        [SerializeField] private GameObject _cookiePrefab; // Can be Cookie or Cookie_Sprite
        [SerializeField] private Transform _spawnParent;
        [SerializeField] private CookieMonsterSpawnAreaBounds cookieMonsterSpawnAreaBounds; // Defines spawn area (no collider)
        ...
        private void Start()
        {
            ...
            if (_cookiePrefab != null && _poolManager != null)
            {
                ...
                if (cookieMonsterSpawnAreaBounds == null)
                {
                    Debug.LogError(
        ...
        private void ClearCookies()
        {
            if (_poolManager != null)
            {
                ...
                foreach (GameObject cookieObj in _spawnedCookies)
                {
                    ...
                    {
                        _poolManager.Return(cookiePoolID, cookieMonsterCookieSprite);
                    }
                }
            }
            else
        ...
        private Bounds GetSpawnBounds()
        {
            if (cookieMonsterSpawnAreaBounds != null)
            {
                return cookieMonsterSpawnAreaBounds.GetBounds();
            }
