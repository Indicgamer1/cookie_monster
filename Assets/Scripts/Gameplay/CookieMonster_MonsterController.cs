...
namespace Eduzo.Games.CookieMonster.Gameplay
{
    ...
    /// </summary>
    public class CookieMonster_MonsterController : MonoBehaviour
    {
        [Header("References")]
        ...
        private void Start()
        {
            ...
            _cookieMonsterEventManager?.Subscribe<AllMonstersReceivedCookieEvent>(OnDistributionRound);
        ...
        public void ReceiveCookie()
        {
            ...
            _cookieMonsterEventManager?.Publish(new CookieDistributedEvent
            {
        ...
        private void DistributeToAllMonsters()
        {
            ...
            CookieMonster_MonsterController[] allMonsters = FindObjectsOfType<CookieMonster_MonsterController>();
        ...
        private void OnDestroy()
        {
            ...
            _cookieMonsterEventManager?.Unsubscribe<AllMonstersReceivedCookieEvent>(OnDistributionRound);
        }
    }
}
