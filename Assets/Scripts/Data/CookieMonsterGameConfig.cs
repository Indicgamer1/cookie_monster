...
namespace Eduzo.Games.CookieMonster.Data
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "New Cookie Monster Settings", menuName = "Eduzo/Games/Cookie Monster/Settings")]
    public class CookieMonsterGameConfig : ScriptableObject
    {
