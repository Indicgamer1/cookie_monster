...
namespace Eduzo.Games.CookieMonster.Data
{
    /// <summary>
    /// Database for all audio clips in the game
    /// Implements a clean lookup system for audio management
    /// </summary>
    [CreateAssetMenu(fileName = "New Cookie Monster Audio Database", menuName = "Eduzo/Games/Cookie Monster/Audio Database")]
    public class CookieMonsterAudioDatabase : ScriptableObject
    {
        [System.Serializable]
