...
namespace Eduzo.Games.CookieMonster.Data
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "New Cookie Monster VFX Database", menuName = "Eduzo/Games/Cookie Monster/VFX Database")]
    public class CookieMonsterVFXDatabase : ScriptableObject
    {
        [System.Serializable]
