...
namespace Eduzo.Games.CookieMonster.Audio
{
    /// <summary>
    ...
    /// </summary>
    public class CookieMonsterAudioManager : MonoBehaviour
    {
        [Header("Audio Settings")]
        [SerializeField] private CookieMonsterAudioDatabase _audioDatabase;
        ...
        private void Start()
        {
            ...
            _cookieMonsterEventManager?.Subscribe<SoundRequestEvent>(OnSoundRequest);
        ...
        {
            // Note: PlayerPrefs removed per coding standards
            // Volume is managed through GameConfig
        }

        private void OnDestroy()
        {
            _cookieMonsterEventManager?.Unsubscribe<SoundRequestEvent>(OnSoundRequest);
        }
    }
}
